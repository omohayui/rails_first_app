...
describe "Static pages" do
    ...
    describe "Home page" do
        ...
        it "should have the h1 'First App'" do
            visit root_path
        ...
        it "should have the base title" do
            visit root_path
            expect(page).to have_title("Ruby on Rails Tutorial First App")
        end
    ...
    describe "Contact page" do
        ...
        it "should have the title 'Contact'" do
            visit contact_path
            expect(page).to have_title("Ruby on Rails Tutorial First App | Contact")
        end
    end
end
